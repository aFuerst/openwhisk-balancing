...
BASEPATH="/extra/alfuerst/openwhisk-logs/bursty/$ITERATION/"
...
locust --headless --users $USERS -r $r -f locustfile-bursty.py --csv "$pth/logs" --log-transactions-in-file &>> "$pth/logs.txt"
