...
python3 plot_tputs.py --path /extra/alfuerst/openwhisk-logs-two/30min-compare/*/* --users $USERS
python3 plot_global_latency.py --path /extra/alfuerst/openwhisk-logs-two/30min-compare/*/* --users $USERS
