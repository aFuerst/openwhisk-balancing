...
python3 compare_function.py --path /extra/alfuerst/openwhisk-logs/bursty-2/*/*-Random* /extra/alfuerst/openwhisk-logs/bursty-2/*/*-Round* /extra/alfuerst/openwhisk-logs/bursty-2/*/*-Bounded* /extra/alfuerst/openwhisk-logs/30min-compare-TTL-bursty/*/* --users $USERS
