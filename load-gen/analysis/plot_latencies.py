...
# ax.legend()
save_fname = os.path.join(path, "latencies", "{}.png".format("warm_latencies_box"))
...
# ax.set_xlabel("Normalized latency")
# ax.legend()
save_fname = os.path.join(path, "latencies", "{}.png".format("cold_latencies_box"))
plt.savefig(save_fname, bbox_inches="tight")
plt.close(fig)
...
# ax.set_xlabel("Normalized latency")
# ax.legend()
save_fname = os.path.join(path, "latencies", "{}.png".format("latencies_box"))
plt.savefig(save_fname, bbox_inches="tight")
plt.close(fig)